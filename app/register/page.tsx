        ...
        <div className="w-full max-w-2xl p-8 bg-white/80 backdrop-blur-md border border-white/50 rounded-2xl shadow-2xl">
          <div className="text-center py-8 fade-in">
            ...
            <p className="text-gray-600 mb-4">
              Welcome to the dojo, <span className="text-emerald-600 font-semibold">{formData.name}</span>!
            </p>
            <p className="text-gray-600 mb-6">A confirmation has been sent to your WhatsApp.</p>
            <a
    ...
    <div className="bg-gradient-to-br from-zinc-50 to-slate-200 min-h-screen flex items-center justify-center font-sans text-gray-900 py-12 px-4">
      <div className="w-full max-w-2xl p-8 bg-white/80 backdrop-blur-md border border-white/50 rounded-2xl shadow-2xl">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-2">Complete your profile to register.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-4">
            <h2 className="text-lg font-semibold text-gray-800 border-b border-gray-200 pb-2">Account Security</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1">
                ...
                <p className="text-xs text-gray-500">
                  Must be at least 8 characters, a password manager is highly recommended.
                </p>
              </div>
          ...
          <div className="space-y-4">
            <h2 className="text-lg font-semibold text-gray-800 border-b border-gray-200 pb-2">Training Information</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-1 md:col-span-2">
                <label className="block text-sm font-medium text-gray-700">Last Grading Date</label>
                <input
                  type="date"
          ...
          <div className="space-y-4">
            <h2 className="text-lg font-semibold text-gray-800 border-b border-gray-200 pb-2">Emergency Contact</h2>
          ...
          <div className="space-y-4">
            <h2 className="text-lg font-semibold text-gray-800 border-b border-gray-200 pb-2">Medical Information</h2>
          ...
          <div className="space-y-4">
            <h2 className="text-lg font-semibold text-gray-800 border-b border-gray-200 pb-2">Consent & Agreements</h2>
            ...
            <div className="space-y-3">
              <label className="flex items-start gap-3 cursor-pointer group">
                ...
                <span className="text-sm text-gray-600 group-hover:text-gray-900 transition-colors">
                  I consent to the storage and processing of my personal data for membership purposes.{' '}
              ...
              <label className="flex items-start gap-3 cursor-pointer group">
                ...
                />
                <span className="text-sm text-gray-600 group-hover:text-gray-900 transition-colors">
                  (Optional) I would like to receive news, updates, and promotional emails.
                </span>
              </label>
            </div>
          </div>
